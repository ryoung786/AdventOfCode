defmodule Aoc2020.Days.D_13 do
  use Aoc2020.Days.Base

  defp parse_input_str(str) do
    [arrival, bus_ids_str] = str |> Util.str_array()
  ...
  def part_one(str) do
    ...
    {"Part 1:", bus_id * (time - arrival)}
  end

  @impl true
  def part_two(str), do: {"Part 2:", parse_input_str(str) |> elem(1) |> calculate_time()}
